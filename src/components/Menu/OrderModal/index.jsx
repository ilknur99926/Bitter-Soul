export default function OrderModal({ t, formData, setFormData, handleOrderSubmit, setShowOrderModal, setShowCartModal }) {
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/50">
      <form onSubmit={handleOrderSubmit} className="bg-[oklch(97%_0.08_30)] text-[oklch(30%_0.1_20)] w-full max-w-sm rounded-xl p-6 shadow-lg">
        ...
        <div className="flex justify-between mt-4">
          <button
            type="button"
            onClick={() => { setShowOrderModal(false); setShowCartModal(true); }}
